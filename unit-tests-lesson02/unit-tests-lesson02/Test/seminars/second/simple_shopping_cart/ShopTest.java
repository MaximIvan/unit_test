...
*/
    ...
    /**
     * Второй вариант решения, но все время выдает ошибку!
     */
    @Test
    void lastProductsDisappearFromStoreTwo() {
        ...
        cart.addProductToCartByID(1);
        assertEquals("Этого товара нет в наличии",output);
...
//    @RepeatedTest(10)
//    @Timeout(value = 200) // TimeUnit.MILLISECONDS - никак не хочет импортироваться!!!
    @Disabled
