...
//        }
        ...
        // try {
        //     seminars.first.homework.Calculator.Calculator.calculation(8, 4, '_');
...
//         assertThatThrownBy(() ->
//                 seminars.first.homework.Calculator.Calculator.squareRootExtraction(0, 1, -1)
...
//         assertThatThrownBy(() ->
//                seminars.first.homework.Calculator.Calculator.calculation(5, 0, '/')
...
//         if (0 != seminars.first.homework.Calculator.Calculator.calculation(2, 6, '+')) {
//             throw new AssertionError("Ошибка в методе");
//         }
//           assert 0 == seminars.first.homework.Calculator.Calculator.calculation(2, 6, '+');
